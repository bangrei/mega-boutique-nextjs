        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          {products.map((p, i) => {
            return (
              <div
                key={i}
                className="rounded-lg overflow-hidden flex flex-col h-full border border-slate-300/50 relative"
              >
                {p.sale && (
                ...
                />
                <div className="px-5 w-full flex items-center justify-between py-1">
                  <small className="text-secondary-light text-sm md:font-bold">
                    Save ${p.discount}
                  </small>
                  <div
                ...
                <div className="px-5 mb-2 font-semibold md:font-light md:text-center lg:text-left">
                  {p.name}
                </div>
                <div className="px-5 w-full flex md:flex-col lg:flex-row items-center justify-between gap-4 py-4 mt-auto">
                  <div className="flex flex-row gap-2 md:justify-center md:w-full lg:w-auto lg:gap-0 lg:flex-col">
